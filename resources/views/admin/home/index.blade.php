    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mt-4">
            <div class="col-lg-5 mb-lg-0 mb-4">
                <div class="card z-index-2">
                    ...
                    <div class="card-body p-3">
                        ...
                        <h6 class="ms-2 mt-4 mb-0"> Statistcs </h6>
                            ...
                            <div class="row">
                                <div class="col-3 py-3 ps-0">
                                    <div class="d-flex mb-2">
                                        ...
                                        <p class="text-xs mt-1 mb-0 font-weight-bold">categories</p>
                                    </div>
                                    <h4 class="font-weight-bolder">{{ $category_count }}</h4>
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $product_count }}</h4>
                                    <div class="progress w-75">
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $order_count }}</h4>
                                    <div class="progress w-75">
                                ...
                                <div class="col-3 py-3 ps-0">
                                    ...
                                    <h4 class="font-weight-bolder">{{ $user_count }}</h4>
                                    <div class="progress w-75">
            ...
            <div class="col-lg-7">
                <div class="card z-index-2">
                    <div class="card-header pb-0">
                        <h6>Current vs previous year orders</h6>
                    </div>
                    <div class="card-body p-3">
                        <div class="chart">
                ...
                <div class="card">
                    ...
                    <div class="card-body px-4 pb-4">
                        <div class="table-responsive p-0">
                            <table id="example" class="table table-bordered border-light text-center"
                                style="width:100%">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                ...
                                <tbody>
                                    @foreach ($last_products as $i => $item)
                                        <tr>
                                            <td>{{ $i + 1 }}</td>
                                            <td>
                                                <img src="{{ env('APP_URL') . '/storage/' . $item->image }}"
        ...
        @push('script')
            <script src="{{ env('APP_URL') . asset('admin_files/assets/js/plugins/chartjs.min.js') }}"></script>
            <script>
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderSkipped: false,
                            backgroundColor: "#fff",
                            data: @json($currentYearData), // Pass the array to JavaScript
                            maxBarThickness: 6
                        }, ],
                    },
                    options: {
                ...
                new Chart(ctx2, {
                    ...
                    data: {
                        ...
                        datasets: [{
                                ...
                                fill: true,
                                data: @json($currentYearData), // Current year data
                                maxBarThickness: 6
                            ...
                            },
                            {
                                ...
                                fill: true,
                                data: @json($previousYearData), // Previous year data
                                maxBarThickness: 6
                            },
                        ],
                    },
